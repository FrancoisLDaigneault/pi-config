...
| --- | --- | --- | --- |
| Test suite duration | 2.97 s (70 tests) | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 70 (48 unit / 20 integration / 2 e2e) | 100% green, 3 levels | `uv run pytest` (pre-commit framework + CI) |
