...
| --- | --- | --- | --- |
| Test suite duration | 3.06 s (58 tests) | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 58 (36 unit / 20 integration / 2 e2e) | 100% green, 3 levels | `uv run pytest` (pre-commit framework + CI) |
