...
| --- | --- | --- | --- |
| Test suite duration | 3.09 s (55 tests) | < 5 s | `uv run pytest -q` (CI gate) |
...
| Green tests | 55 (33 unit / 20 integration / 2 e2e) | 100% green, 3 levels | `uv run pytest` (pre-commit framework + CI) |
